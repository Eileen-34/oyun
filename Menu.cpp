...
Menu::Menu(const sf::Font& font) {
    ...
    buttons.emplace_back("Game Rules", font, sf::Vector2f(300, 500), sf::Vector2f(200, 50));
    buttons.emplace_back("About", font, sf::Vector2f(300, 600), sf::Vector2f(200, 50));
    buttons.emplace_back("Exit", font, sf::Vector2f(300, 700), sf::Vector2f(200, 50));
}
